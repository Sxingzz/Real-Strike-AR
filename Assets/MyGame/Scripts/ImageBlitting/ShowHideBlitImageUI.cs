...
public class ShowHideBlitImageUI : NetworkBehaviour
{
    ...
    private void Start()
    {
        ...
        StartGameAR.OnStartSharedSpace += 
                            StartNetworkingManagerSharedARImageOnOnSharedSpaceStarted;
    ...
    private void StartNetworkingManagerSharedARImageOnOnSharedSpaceStarted()
    {
        ...
        {
            _rectTransform.sizeDelta = new Vector2(_renderTexture.width / 3.25f, 
                                                       _renderTexture.height / 3.25f);
        }
        else
        {
